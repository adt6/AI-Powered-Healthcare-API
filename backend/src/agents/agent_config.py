...
INSTRUCTIONS_FILE_PATH = Path(__file__).parent.parent / "agents" / "prompts" / "clinical_instructions.md"
...
MODEL_ID_LLAMA_GROQ = "llama-3.3-70b-versatile"  # Llama 3.3 70B - Groq docs confirm tool use support
